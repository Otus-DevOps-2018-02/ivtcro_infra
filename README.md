...
___
# HOMEWORK №12: Vagrnat <a name="homework_12"></a>
## Локальная разработка с Vagrant
### Что сделано:
1. Создана конфигурация vagrant для запуска локально двух ВМ и разворачивания на них приложения reddit:
...
### Как проверить:
В папке `ansibe` выполнить комманду `vagrant up`, после завершения работы vagrant'а открыть в браузере страницу `http//10.10.10.20:9292`

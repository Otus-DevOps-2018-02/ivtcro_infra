...
2. Добавлен русурс для создания статического внешнего адреса, файл деплоя изменен для назначения его VM с приложением
...
9. Добавлены провижионеры для деполоя приложения и для настройки приложения и db с учетом работы на разных ВМ
10. Добавлена переменная deploy_app, определяющая необходимость деплоя приложения. TODO: сделать провижионеры приложения условными
